...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (changeBtn) {
    changeBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        // Clear previous feedback on the index page
  ...
  async function sendAudio(blob, context) {
    try {
      ...
      // Extra fields: question_id or job_id + question_id
      ...
      // Update inline feedback (used on the index page)
  ...
  // 3) HOOK FOR INDEX PAGE (generic practice audio)
  ...
  if (indexStartBtn && indexStopBtn) {
    indexStartBtn.addEventListener("click", () => {
      ...
      const context = {
        ...
        expectHtmlResult: false, // keep inline feedback on index
      };
